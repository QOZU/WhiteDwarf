...
#[derive(Debug)]
pub struct WhiteDwarfProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WhiteDwarfProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WhiteDwarf processing");
    
    let mut processor = WhiteDwarfProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WhiteDwarfProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WhiteDwarfProcessor::new(false);
